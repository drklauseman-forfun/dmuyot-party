...
export const CHARACTER_EFFECTS: CharacterEffect[] = [
  ...
  },
  {
    ...
    modules: [
      { type: 'edgeGlow', edge: 'bottom', color: '#5dff9b', intensity: 0.75, spread: 0.55, fadeInDuration: 1.6, duration: 4.5, fadeDuration: 1.2 },
      // Anticlockwise: time running backwards rather than forwards.
      { type: 'clock', color: '#7dffb0', radius: 0.28, marks: 12, tickRate: -2, fadeInDuration: 1.6, duration: 4.5, fadeDuration: 1.2 },
    ],
  },
];
